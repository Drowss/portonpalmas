    ...
    public ResponseEntity<?> forgotPassword(EmailRequest emailRequest) {
        ...
        try {
            ...
            String content = "<html>"
                    ...
                    + "<a href='http://localhost:4200/reset-password?token=" + token + "' style='display: inline-block; font-weight: bold; background-color: #fcc200; color: black; padding: 10px 20px; margin: 20px 0; text-decoration: none; border-radius: 5px;'>Restablecer contraseña</a>"
